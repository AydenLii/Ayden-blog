---
title: 泛型机制详解
date: 2022-08-26 21:26:17
permalink: /pages/7f4e85/
categories:
  - 编程资料
  - JAVA学习笔记
  - 面试题库
...
![img](https://picgo-1307188483.cos.ap-nanjing.myqcloud.com/java-basic-generic-4.png)

- 调用泛型方法语法格式

![img](https://picgo-1307188483.cos.ap-nanjing.myqcloud.com/java-basic-generic-5.png)
...
![img](https://picgo-1307188483.cos.ap-nanjing.myqcloud.com/java-basic-generic-1.png)
...
![img](https://picgo-1307188483.cos.ap-nanjing.myqcloud.com/java-basic-generic-2.png)

- 擦除方法定义中的类型参数

擦除方法定义中的类型参数原则和擦除类定义中的类型参数是一样的，这里仅以擦除方法定义中的有限制类型参数为例。

![img](https://picgo-1307188483.cos.ap-nanjing.myqcloud.com/java-basic-generic-3.png)
